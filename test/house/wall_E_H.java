public class wall_E_H extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_E_H(double x, double y, double z){
	...
	public void makePolygons(){
		...
		t = new vector[]{put(0, 15.03, 19.5), put(0, 15.03, 0), put(0, 0.5, 0), put(0, 0.5, 19.5)};
