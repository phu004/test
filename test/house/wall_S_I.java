public class wall_S_I extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_S_I(double x, double y, double z){
	...
	public void makeBoundary(){
		start.add(0,0,-0.5);
		double x = 20; double y = 15; double  z = 1;
	...
	public void makePolygons(){
		...
		polygons[8].scaleX = 5;
		polygons[8].ambient_I = 4;

		t = new vector[]{put(22.9, 0, 0.3), put(24.7, 0, 0.3), put(24.7, 0.5, 0.3), put(22.9, 0.5, 0.3)};
		polygons[9] = new polygon3D(t, t[0],  t[1], t[3], house.textures[3]);
		polygons[9].ambient_I = 2;
		...
		t = new vector[]{put(5, 0, 0.3), put(17.03, 0, 0.3), put(17.03, 0.5, 0.3), put(5, 0.5, 0.3)};
		polygons[11] = new polygon3D(t, t[0],  t[1], t[3], house.textures[3]);
		polygons[11].scaleX = 5;
		polygons[11].ambient_I = 1;

		t = new vector[]{put(17.03, 0.5, 0), put(5, 0.5, 0), put(5, 0.5, 0.3) ,put(17.03, 0.5, 0.3)};
		polygons[12] = new polygon3D(t, t[0],  t[1], t[3], house.textures[3]);
		polygons[12].scaleX = 5;
		polygons[12].ambient_I = -1;


		t = new vector[]{put(5,12, 0), put(25,12, 0), put(25,15.01, 0), put(5,15.01, 0)};
		...
		t = new vector[]{put(5,0.5, 0), put(17.47,0.5, 0), put(17.47,12.1, 0), put(5,12.1, 0)};
		...
		polygons[2+index].ambient_I = 3;
		
		t = new vector[]{put(5, 0.5, 0.3), put(5, 0.5, 0), put(5, 0, 0), put(5, 0, 0.3)};
