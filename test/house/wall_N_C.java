public class wall_N_C extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_N_C(double x, double y, double z){
	...
	public void makePolygons(){
		...
		polygons[0+index].ambient_I = -2;

		t = new vector[]{put(0,0.5, 0), put(17.47,0.5, 0), put(17.47,12.1, 0), put(0,12.1, 0)};
		polygons[1+index] = new polygon3D(t, t[0],  t[1], t[3], house.textures[2]);
		polygons[1+index].scaleX = 2;
		polygons[1+index].scaleY = 2;
		polygons[1+index].ambient_I = -2;
