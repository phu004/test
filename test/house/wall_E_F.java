public class wall_E_F extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_E_F(double x, double y, double z){
	...
	public void makePolygons(){
		...
		t = new vector[]{put(0, 0.5, 19.52), put(0, 0.5,0), put(-0.3, 0.5, 0), put(-0.3, 0.5, 19.52)};
