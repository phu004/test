public class floorG extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public floorG(double x, double y, double z){
	...
	public void makeBoundary(){
		double x = 20; double y = 0.01; double  z = 20;
	...
	public void makePolygons(){
		...
		t = new vector[]{put(0, 0,  0), put(0, 0, 20), put(20, 0, 20), put(20, 0, 0)};
		polygons[0] = new polygon3D(t, t[0],  t[1], t[3], house.textures[22]);
		polygons[0].scaleX =7;
		polygons[0].scaleY = 5;
		polygons[0].ambient_I = 2;

		for(int i = 0; i < 1; i++)
			polygons[i].setLightSource( LightSource.s7);
	}
