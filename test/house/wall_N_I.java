...
public class wall_N_I extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	
	public wall_N_I(double x, double y, double z){
	...
	public void makePolygons(){
		...
		t = new vector[]{put(-0.01, 15, 0.3), put(20, 15, 0.3), put(20, 0.5, 0.3), put(-0.01, 0.5, 0.3)};
		polygons[2] = new polygon3D(t, t[0],  t[1], t[3], house.textures[2]);
		polygons[2].scaleX = 2;
		polygons[2].scaleY = 2;
		polygons[2].ambient_I = -1;

		t = new vector[]{put(0, 0.5, 0), put(19.7, 0.5, 0), put(19.7, 0, 0), put(0,0,0)};
		polygons[1] = new polygon3D(t, t[0],  t[1], t[3], house.textures[3]);
		polygons[1].scaleX = 8;
		polygons[1].ambient_I = 0;

		t = new vector[]{put(0, 0.5, 0.3), put(20, 0.5, 0.3), put(20, 0.5, 0), put(0, 0.5, 0)};
