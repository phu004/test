public class ceiling_E extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public ceiling_E(double x, double y, double z){
	...
	public void makePolygons(){
		polygons = new polygon3D[1];
			...
			t = new vector[]{put(0, 0, 0),  put(25.02,0,0), put(25.02, 0, 10), put(0, 0, 10)};
			polygons[0] = new polygon3D(t, t[0],  t[1], t[3], house.textures[4]);
			polygons[0].scaleX = 3;
			polygons[0].scaleY = 1;
			polygons[0].ambient_I = 7;
