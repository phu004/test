public class wall_E_J extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_E_J(double x, double y, double z){
	...
	public void makePolygons(){
		...
		t = new vector[]{put(-0.30, 0.5, 19.5), put(-0.30, 0.5, 0.3), put(-0.31, 0, 0.3), put(-0.3, 0, 19.5)};
