public class door_I  extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;

	public door_I(double x, double y, double z){
	...
	public void makeBoundary(){
		start.add(0,0,2);
		double x = 5; double y = 12; double  z = 0.3;
	...
	public void makePolygons(){
		...
		polygons[16] = new polygon3D(t, t[0], t[3], t[1], gameData.glass2);
		polygons[16].type = 3;
		...
		polygons[17] = new polygon3D(t, t[0], t[3], t[1], gameData.glass2);
		polygons[17].type = 3;
