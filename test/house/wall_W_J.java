public class wall_W_J extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public wall_W_J(double x, double y, double z){
	...
	public void makePolygons(){
		...
		t = new vector[]{put(0, 15, 19.5), put(0, 15, 0), put(0, 0.5, 0), put(0, 0.5, 19.5)};
		polygons[2] = new polygon3D(t, t[0],  t[1], t[3], house.textures[48]);
		polygons[2].scaleX = 5;
		polygons[2].scaleY = 5;
		polygons[2].ambient_I = 3;

		t = new vector[]{put(0, 0.5, 12.5), put(0, 0.5,0), put(-0.3, 0.5, 0), put(-0.3, 0.5, 12.5)};
		polygons[1] = new polygon3D(t, t[0],  t[1], t[3], house.textures[47]);
		polygons[1].scaleX = 8;
		polygons[1].ambient_I = 3;

		t = new vector[]{put(-0.30, 0.5, 12.5), put(-0.30, 0.5, 0), put(-0.31, 0, 0), put(-0.3, 0, 12.5)};
