public class floorD extends solidObject{

	public vector start;
	public vector iDirection, jDirection, kDirection;
	public vector[] specularCentre;

	public floorD(double x, double y, double z){
	...
	public void makeBoundary(){
		double x = 25; double y = 0.01; double  z = 20;
	...
	public void makePolygons(){
		...
		t = new vector[]{put(0, 0,  0), put(0, 0, 19.5), put(25, 0, 19.5), put(25, 0, 0)};
